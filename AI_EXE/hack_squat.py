...
class HackSquatTrainerAI:
    ...
    def process(self, frame, keypoints, confs):
        ...
        if confs[11] > 0.4 and confs[13] > 0.4 and confs[15] > 0.4 and confs[5] > 0.4:
            ...
            self.coach.on_error(HACK_SQUAT_SETUP, urgent=True)
            return frame

        self.coach.reset_error(HACK_SQUAT_SETUP)
        ...
        if knee_angle < 95:
            if self.stage != "down":
                ...
                self.coach.reset_error(HACK_SQUAT_DEPTH)
        ...
        # ── 2) Top (Stand up) ──
            ...
            if self.stage == "down":
                ...
                self.coach.reset_error(HACK_SQUAT_PUSH)
                self.coach.reset_error(HACK_SQUAT_DEPTH)
        ...
        # ── 3) Hysteresis: Short Rep while descending ──
            ...
            if knee_angle - self.min_angle_this_rep > 15:
                ...
                voice_message = HACK_SQUAT_DEPTH
            else:
