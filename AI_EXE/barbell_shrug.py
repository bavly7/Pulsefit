...
from AI_EXE.messages import (
    BARBELL_SHRUG_SETUP,
    BARBELL_SHRUG_SHRUG,
    BARBELL_SHRUG_SQUEEZE,
    BARBELL_SHRUG_DROP,
    GOOD_REP,
)

class BarbellShrugTrainerAI:
    ...
    def process(self, frame, keypoints, confs):
        ...
        if confs[3] > 0.4 and confs[5] > 0.4 and confs[11] > 0.4:
            ...
            self.coach.on_error(BARBELL_SHRUG_SETUP, urgent=True)
            return frame

        self.coach.reset_error(BARBELL_SHRUG_SETUP)
        ...
        if current_angle < 140:
            if self.stage == "down":
                ...
                self.coach.reset_error(BARBELL_SHRUG_SHRUG)
                self.coach.reset_error(BARBELL_SHRUG_DROP)
        ...
        # ── 3) Hysteresis: Ascending (Shrugging, stage=="down") ──
            ...
            if current_angle - self.min_angle_this_rep > 15:
                ...
                voice_message = BARBELL_SHRUG_SHRUG
            else:
        ...
        # ── 4) Hysteresis: Descending (Lowering, stage=="up") ──
            ...
            if self.max_angle_this_rep - current_angle > 15:
                ...
                current_color = (0, 165, 255)
                voice_message = BARBELL_SHRUG_DROP
            else:
