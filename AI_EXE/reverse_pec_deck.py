...
from AI_EXE.messages import (
    REV_PEC_DECK_SETUP,
    REV_PEC_DECK_PULL,
    REV_PEC_DECK_STRETCH,
    REV_PEC_DECK_SQUEEZE,
    GOOD_REP,
)

class ReversePecDeckTrainerAI:
    ...
    def process(self, frame, keypoints, confs):
        ...
        if confs[6] > 0.4 and confs[8] > 0.4 and confs[10] > 0.4 and confs[12] > 0.4:
            ...
            self.coach.on_error(REV_PEC_DECK_SETUP, urgent=True)
            return frame

        self.coach.reset_error(REV_PEC_DECK_SETUP)
        ...
        if current_angle > 130:
            if self.stage == "down":
                ...
                self.coach.reset_error(REV_PEC_DECK_PULL)
                self.coach.reset_error(REV_PEC_DECK_STRETCH)
        ...
        # ── 3) Hysteresis: Ascending (stage=="down") ──
            ...
            if self.max_angle_this_rep - current_angle > 15:
                ...
                voice_message = REV_PEC_DECK_PULL
            else:
        ...
        # ── 4) Hysteresis: Descending (stage=="up") ──
            ...
            if current_angle - self.min_angle_this_rep > 15:
                ...
                current_color = (0, 165, 255)
                voice_message = REV_PEC_DECK_STRETCH
            else:
